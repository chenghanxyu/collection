...
}).then(function(){window.location.href= "https://h5.smartcinema.com.tw/exchange-intl-tw/index.html?code=6pkS&_lang=zh_TW"});
					}
...
.then(
  function(){window.location.href= "https://smartcinematw.neocities.org/pairs_game/for_app.html"}
  );
